...
class UpcomingMovieImage extends StatefulWidget {
  final double? rating;
  final String url;
  final String title;
  final String releaseDate;

  const UpcomingMovieImage({
    Key? key,
  ...
  @override
  State<UpcomingMovieImage> createState() => _UpcomingMovieImageState();
}

class _UpcomingMovieImageState extends State<UpcomingMovieImage> {

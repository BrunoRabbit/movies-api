...
/// A class which mocks [TopRatedModel].
///
/// See the documentation for Mockito's code generation for more information.
class MockTopRatedModel extends _i1.Mock implements _i5.TopRatedModel {
  @override
  List<Object?> get props => (super.noSuchMethod(
        Invocation.getter(#props),
        returnValue: <Object?>[],
  ...
  @override
  _i5.TopRatedModel wrapperFromJson(String? source) => (super.noSuchMethod(
        Invocation.method(
          #wrapperFromJson,
          [source],
        ),
        returnValue: _FakeTopRatedModel_3(
          this,
          Invocation.method(
            #wrapperFromJson,
            [source],
        ...
        returnValueForMissingStub: _FakeTopRatedModel_3(
          this,
          Invocation.method(
            #wrapperFromJson,
            [source],
  ...
  @override
  _i5.TopRatedModel wrapperFromMap(Map<String, dynamic>? map) =>
      (super.noSuchMethod(
        Invocation.method(
          #wrapperFromMap,
          [map],
